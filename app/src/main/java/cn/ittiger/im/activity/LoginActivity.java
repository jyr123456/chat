...
public class LoginActivity extends IMBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initUserInfo();
        Intent i=getIntent();
        if(i.getStringExtra("username")!=null  && i.getStringExtra("username")!=""){
            mEditTextUser.setText(i.getStringExtra("username"));
        }
        if(i.getStringExtra("password")!=null && i.getStringExtra("password")!=""){
            mEditTextPwd.setText(i.getStringExtra("password"));
        }
